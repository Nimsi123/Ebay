...
class ItemList:
    ...
    def appendFileToFile(oldFile, tempFileName, writeHeader):
        with open(tempFileName, "a", encoding = "utf-8") as ebay_csv_temp:
            ...
            with open(oldFile, "r", encoding = "utf-8") as ebay_csv:
                ...
                #if the reader already has a header, let the .writerow() method put the header, not csv_writer.writeheader()
                if writeHeader:
                    csv_writer.writeheader()
